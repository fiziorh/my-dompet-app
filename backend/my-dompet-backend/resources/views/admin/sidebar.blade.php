...
<aside class="main-sidebar sidebar-light-primary elevation-4">
    ...
    <a href="/dashboard" class="brand-link">
        ...
        <span class="brand-text font-weight-light">{{ config('app.name', 'Your App Name') }}</span>
    </a>
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                    ...
                    <li class="nav-item">
                        <a href="/income" class="nav-link{{ $active === 'income' ? ' active' : '' }}">
                            <i class="nav-icon fas fa-tachometer-alt"></i>
                            <p>
                                Income
                            </p>
                    ...
                    <li class="nav-item">
                        <a href="/spending" class="nav-link{{ $active === 'spending' ? ' active' : '' }}">
                            <i class="nav-icon fas fa-tachometer-alt"></i>
                            <p>
                                Spending
                            </p>
